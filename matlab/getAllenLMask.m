...
% 
%% Description
% `out = getAllenLMask(resolution)` returns the logical mask, where voxels in
% the left hemisphere at the specified resolution are set to true and others to
% false.
% 
% 
%% Examples
...
% 
%% Output Arguments
% `out - left hemisphere mask (logical 3D array)` Logical array with true values
% for voxels in the left hemisphere.
% 
% 
%% Usage Notes
