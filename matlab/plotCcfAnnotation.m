function [out, v, slice] = plotCcfAnnotation(V, varargin)
...
ip.addParameter('roundResolution', 1, @(x)validateattributes(x,{'numeric'},{'integer','positive'}));
...
if slice<1; slice = ceil(size(V,dim)*slice/rr-1)*rr+1;
